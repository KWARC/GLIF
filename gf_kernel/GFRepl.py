...
clean : remove all %s files from the current working directory.
...
Defined grammars are saved in the current working directory and automatically imported upon definiton.""" % (" ".join(self.to_clean_up))))
                    else:
                        cmd = '%s %s' % (name, args)
